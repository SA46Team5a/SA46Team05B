...
namespace SA46Team05BESNETProject.DataSet2TableAdapters {
    ...
    public partial class MembersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Members] ([NRIC], [MemberName], [Phone], [Gender], [Age]) VALUES (@N" +
                "RIC, @MemberName, @Phone, @Gender, @Age);\r\nSELECT NRIC, MemberName, Phone, Gende" +
                "r, Age FROM Members WHERE (NRIC = @NRIC)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Members] SET [NRIC] = @NRIC, [MemberName] = @MemberName, [Phone] = @Phone, [Gender] = @Gender, [Age] = @Age WHERE (([NRIC] = @Original_NRIC) AND ((@IsNull_MemberName = 1 AND [MemberName] IS NULL) OR ([MemberName] = @Original_MemberName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)));
SELECT NRIC, MemberName, Phone, Gender, Age FROM Members WHERE (NRIC = @NRIC)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Members.*\r\nFROM   Members";
        ...
        public virtual int Fill(DataSet2.MembersDataTable dataTable) {
        ...
        public virtual DataSet2.MembersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet2.MembersDataTable dataTable = new DataSet2.MembersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet2.MembersDataTable dataTable) {
